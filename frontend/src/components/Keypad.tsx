...
const KEY_STYLE =
  'rounded-2xl bg-white font-display text-3xl font-bold text-ink shadow-[0_4px_0_rgba(0,0,0,0.15)] active:translate-y-1 active:shadow-none'
  ...
  return (
    <div role="group" aria-label="Number keypad" className="grid w-full max-w-xs grid-cols-3 gap-3">
      ...
      <button
        ...
        className="tap-target rounded-2xl bg-ink font-display text-lg font-semibold leading-tight text-base disabled:opacity-40"
      >
        Check answer
      </button>
    </div>
