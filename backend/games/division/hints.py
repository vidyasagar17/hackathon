...
def generate_hint(problem: Problem, misconception: MisconceptionName) -> str:
    ...
    The sentence is built deterministically from the student's numbers. The LLM rewording is
    shown only if `vet_hint` accepts it and `keeps_facts` confirms it states the same numbers,
    place names and comparison words in the same order; otherwise the sentence is shown.
    """
            ...
            messages=[
                {
                    ...
                    "content": (
                        ...
                        "sounds friendly and encouraging. Keep every number and every place "
                        "name (ones, tens) exactly as written and in the same order. Do not "
                        "add numbers, steps, or advice. No jargon. "
