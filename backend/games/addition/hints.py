...
def generate_hint(problem: Problem, misconception: MisconceptionName) -> str:
    ...
    and column names in the same order; otherwise the sentence itself is shown.
    """
            ...
            messages=[
                {
                    "role": "system",
                    "content": (
                        "You reword a math hint for a 2nd or 3rd grade student so it "
                        "sounds friendly and encouraging. Keep every number and every "
                        "column name (ones, tens, hundreds, thousands) exactly as written "
                        "and in the same order. Do not add numbers, steps, or advice. "
